...
var modal_title1 = "UWA Collected";
var modal_title2 = "launches October&nbsp;2023";
var modal_message = "For more information, contact the University Library.";
var modal_button1_text = "Contact us";
var modal_button2_text = "Admin login";
var modal_button1_link = "https://www.uwa.edu.au/library/Help-and-support/Contact";
var modal_button2_link = "/users/login";

// Set to 'true' if the modal should not show again after a user has seen it once
var modal_only_show_once = false;
...
$(document).ready(function () {
	...
	if (document.getElementById("client_menu").getElementsByClassName("profile").item(0).innerHTML.includes("Login")) {
